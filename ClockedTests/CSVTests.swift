...
final class CSVTests: XCTestCase {
    ...
    private let header = "date,clock_in,clock_out,break_minutes,net_hours"
    ...
    func testFullExportGoldenString() {
        ...
        let a = sessionWithBreak(date(2026, 7, 13, 9, 0), date(2026, 7, 13, 16, 0),
                                 ...
                                 breakEnd: date(2026, 7, 13, 12, 30))       // net 6.50h, brk 30
        ...
        let expected = [
            header,
            "2026-07-13,09:00,16:00,30,6.50",
            "2026-07-14,08:05,14:35,0,6.50",
            "2026-07-16,09:00,15:00,51,5.16",
            "2026-07-17,09:00,(active),0,2.25",
            "total,,,,20.41",   // 6.5 + 6.5 + 5.158333… + 2.25 = 20.408333…
        ].joined(separator: "\n")
